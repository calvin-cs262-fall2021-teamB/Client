    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.modalView}>
          <Text style={{ fontSize: 24, fontWeight: "bold" }}>Help: Order</Text>
          <Text style={{ fontSize: 18 }}>
            {"\n"}To view the food menu, click the burger icon button.
          </Text>
          <Text style={{ fontSize: 18 }}>
            {"\n"}To view the beverage menu, click the drink icon button.
          </Text>
          <Text style={{ fontSize: 18 }}>
            {"\n"}Review your order by clicking on the cart icon button.
          </Text>
          <Text style={{ fontSize: 18 }}>
          ...
          <Text style={{ fontSize: 18 }}>
            {"\n"}To view your profile, press the right button on the tab bar
